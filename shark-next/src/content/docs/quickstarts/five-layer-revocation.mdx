...
**API reference:** [`/documentation/api/oauth.md#revoke`](/oauth.md)
...
**API reference:** [`/documentation/api/agents.md#revoke-all`](/agents.md)
...
**API reference:** [`/documentation/api/users.md#revoke-agents`](/users.md)
...
- Customer agent provisioning: [01 — Customer Agents](./customer-agents.md)
- Delegation chains (what's in the audit trail): [11 — Delegation Chains](./delegation-chains.md)
- Audit log API: [`/documentation/api/audit-logs.md`](/audit-logs.md)
- Agents API: [`/documentation/api/agents.md`](/agents.md)
