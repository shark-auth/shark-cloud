---
title: "Auth0 Replacement: Self-host auth with agent support"
order: 4
...
See [`/documentation/api/auth.md`](/auth.md) for the full human auth API.
...
This is the step Auth0 doesn't have. From here, see [01 — Customer Agents](./customer-agents.md) for the full agent provisioning flow.
...
- Full agent provisioning flow: [01 — Customer Agents](./customer-agents.md)
- Human auth API reference: [`/documentation/api/auth.md`](/auth.md)
- OAuth provider reference: [`/documentation/api/oauth.md`](/oauth.md)
