---
title: "Internal Platform: AI platform with compliance audit trails"
order: 3
...
See [`/documentation/cli/serve.md`](/serve.md) for full options.
...
See [11 — Delegation Chains](./delegation-chains.md) for the full 3-hop walkthrough.
...
See [`/documentation/api/audit-logs.md`](/audit-logs.md) for the full event schema.
...
The method exists in the SDK today; the backend endpoint ships in v0.2. See [`10-five-layer-revocation.md`](./five-layer-revocation.md) for Layer 4 detail.
...
- Full revocation model (all 5 layers): [10 — Five-Layer Revocation](./five-layer-revocation.md)
- Delegation chains in depth: [11 — Delegation Chains](./delegation-chains.md)
- Audit log API reference: [`/documentation/api/audit-logs.md`](/audit-logs.md)
- Webhook API reference: [`/documentation/api/webhooks.md`](/webhooks.md)
