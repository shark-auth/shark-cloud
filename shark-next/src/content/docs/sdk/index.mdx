...
- [Agent acts on user's Gmail](./agent-acts-on-gmail.md)
- [Multi-hop delegation chain](./multi-hop-delegation.md)
- [Programmatic admin onboarding](./programmatic-admin-onboarding.md)
