...
- [Agent acts on user's Gmail](./agent-acts-on-gmail.md) — vault + DPoP end-to-end
- [Multi-hop delegation chain](./multi-hop-delegation.md) — orchestrator → worker → tool
